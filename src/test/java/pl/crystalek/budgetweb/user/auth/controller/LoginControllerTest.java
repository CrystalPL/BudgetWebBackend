...
class LoginControllerTest extends BaseAccessControllerTest {
    ...
    void shouldLoginSuccessfullyWhenCredentialsAreValid(boolean rememberMe, boolean expectedRememberMeFlag) throws Exception {
    ...
    void shouldFailValidationWhenInputDataIsInvalid(final String email, final String password, final Boolean rememberMe, final String errorMessage) throws Exception {
        userAccountUtil.register(UserAccountUtil.TESTING_USER);
    ...
    void shouldReturnBadRequestForInvalidLoginScenarios(String email, String password, LoginResponseMessage errorMessage, boolean userExists) throws Exception {
        if (userExists) {
            userAccountUtil.register(UserAccountUtil.TESTING_USER);
        }
    ...
    void shouldSetProperCookiesWhenLoginSuccessful(boolean rememberMe, int expectedMaxAge) throws Exception {
        userAccountUtil.register(UserAccountUtil.TESTING_USER);
        final LoginRequest loginRequest = new LoginRequest("test@example.com", "StrongPassword1!", rememberMe);
