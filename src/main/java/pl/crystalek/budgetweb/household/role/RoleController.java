...
class RoleController {
    ...
    @PreAuthorize("hasRole(T(pl.crystalek.budgetweb.household.role.permission.Permission).ROLE_PERMISSIONS_EDIT)")
    ...
    @PreAuthorize("hasRole(T(pl.crystalek.budgetweb.household.role.permission.Permission).ROLE_PERMISSIONS_VIEW)")
    ...
    @PreAuthorize("hasRole(T(pl.crystalek.budgetweb.household.role.permission.Permission).ROLE_MAKE_DEFAULT)")
    ...
    @PreAuthorize("hasRole(T(pl.crystalek.budgetweb.household.role.permission.Permission).ROLE_CHANGE)")
    ...
    @PreAuthorize("hasRole(T(pl.crystalek.budgetweb.household.role.permission.Permission).ROLE_CREATE)")
    @PostMapping("/create")
    ...
    @PreAuthorize("hasRole(T(pl.crystalek.budgetweb.household.role.permission.Permission).ROLE_DELETE)")
    @DeleteMapping("/delete")
    public ResponseEntity<ResponseAPI<DeleteRoleResponse>> deleteRole(
            @Validated(DeleteRoleRequest.EditRoleRequestValidation.class) @RequestBody final DeleteRoleRequest deleteRoleRequest,
            @AuthenticationPrincipal final long userId
    ) {
    ...
    @PreAuthorize("hasRole(T(pl.crystalek.budgetweb.household.role.permission.Permission).ROLE_EDIT)")
    @PatchMapping("/edit")
