...
class HouseholdInviteMemberController {
    ...
    @PreAuthorize("hasRole(T(pl.crystalek.budgetweb.household.role.permission.Permission).HOUSEHOLD_MEMBER_INVITE)")
    @PostMapping("/invite")
    ...
    @PreAuthorize("hasRole(T(pl.crystalek.budgetweb.household.role.permission.Permission).HOUSEHOLD_MEMBER_CANCEL_INVITATION)")
    @PostMapping("/undo")
